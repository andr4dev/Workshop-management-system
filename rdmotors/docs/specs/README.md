...
| [0011](0011-la-tienda-en-la-nube/spec.md) | La tienda en la nube | spec cerrado · [plan](0011-la-tienda-en-la-nube/plan.md) · **las 5 fases hechas el 2026-09-23** (la pantalla adentro del servidor + Dockerfile; secretos y clave obligatoria; el reloj de afuera con `/api/salud` y `/api/tareas`; el respaldo que se baja, V25) · **desplegado y verificado** en https://workshop-management-system-1-lujm.onrender.com (Render + Neon, gratis, con dos crones que lo mantienen despierto) · le da la vuelta a la decisión más vieja del proyecto: la verdad se muda del computador del almacén a la nube · **después de esto, sin internet no se vende** |
| [0012](0012-carga-de-inventario-desde-excel/spec.md) | Cargar inventario desde un archivo, con pre-carga y precios ajustables | spec cerrado · [plan](0012-carga-de-inventario-desde-excel/plan.md) · **las 6 fases hechas el 2026-09-25** (V26; confirmar la MAG477 real, 592 renglones, en 41 s con los límites del plan gratis; guía en [CARGAR_FACTURA.md](../CARGAR_FACTURA.md)) · **se lee el PDF de Jotapartes directo** (probado con la MAG477 real: 592 de 592 renglones cuadrando) · subir la factura, ver todo calculado sin guardar nada, ajustar precios a mano y confirmar como una sola compra · decidido el 2026-09-25: **el costo lleva IVA** y el precio sugerido es *valor total ÷ cantidad + 19% + 45%* (la regla vale también para las compras a mano) · la pre-carga se guarda en el servidor · el Excel con plantilla queda para otros proveedores |
